...
import com.miitang.facade.marketing.dto.vip.QueryVipMemberResDTO;
 ...
 * VIP运营商会员产品配置接口
 */
public class MA27_VipMemberFacade_queryVipMemberInfo {
    ...
    public void queryVipMemberInfo(String parentMerchantNo,String merchantNo,String message) {
        ...
        try {
            ...
            QueryVipMemberResDTO queryVipMemberResDTO=vipMemberFacade.queryVipMemberInfo(parentMerBaseRequestDTO);

            System.out.println(message+JSONUtils.toJsonString(queryVipMemberResDTO));
