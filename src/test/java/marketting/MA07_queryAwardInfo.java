...
import com.miitang.facade.marketing.dto.parentMerchant.AwardQueryResDTO;
 ...
 */
public class MA07_queryAwardInfo {
    ...
    public void queryPostList() {
        ...
        try {
            ...
            AwardQueryResDTO response = operatorProductManageFacade.queryAwardInfo(request);
...
//            Assert.assertTrue(responseCode.equals(respect));
    ...
    public void queryAwardException(String parentMerchantNo) {
        HessianProxyFactory hessianProxyFactory = new HessianProxyFactory();
        OperatorProductManageFacade operatorProductManageFacade;
