 ...
 */
public class MA15_querySettleProfitDetail {
    String envFlag = CommPro.env;
    String envuri = CommPro.getEnvURI(envFlag);


    @Test(dataProvider = "dp")
    public void querySettleProfitDetail(String parentMerchantNo,String merchantNo,String verify) {
        ...
        try {
            ...
            reqDTO.setLast(Long.parseLong("1000001249"));
            reqDTO.setLength(10);
            QueryProfitResDTO queryProfitResDTO = profitFacade.querySettleProfitDetail(reqDTO);
...
//            Assert.assertTrue(responseCode.equals(respect));
    ...
    public Object[][] dp() {
        return new Object[][]{
                {"1042781335","11050991314821","查询已结算金额"},
                //{"1042781335","11050953278631","查询已结算金额"},
               // {"1111","1111","测试数据"}
    ...
    public void querySettleProfitDetailEXC(String parentMerchantNo,String merchantNo,String verify) {
        HessianProxyFactory hessianProxyFactory = new HessianProxyFactory();
        ProfitFacade profitFacade;
